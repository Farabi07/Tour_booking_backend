...
urlpatterns = [
    ...
    # Booking
    path('booking_tour/', include('booking.urls.tour_urls')),
    path('booking_traveler/', include('booking.urls.traveler_urls')),

    # Order
    path('cart/', include('order.urls.cart_urls')),
    path('cartitem/', include('order.urls.cartItem_urls')),
    path('order/', include('order.urls.order_urls')),

    # Payment
    path('payment/', include('payment.urls.payment_urls')),
